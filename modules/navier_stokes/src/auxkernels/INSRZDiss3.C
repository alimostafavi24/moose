...
#include "INSRZDiss3.h"
#include "MooseMesh.h"
#include "NS.h"

registerMooseObject("NavierStokesApp", INSRZDiss3);

InputParameters
INSRZDiss3::validParams()
{
...
INSRZDiss3::INSRZDiss3(const InputParameters & parameters)
...
INSRZDiss3::computeValue()
{
 ...
 //                 - 2/3 *(_grad_vel_x[_qp](0)+_grad_vel_y[_qp](1)+_vel_x[_qp]/_q_point[_qp](0))*(_grad_vel_x[_qp](0)+_grad_vel_y[_qp](1)+_vel_x[_qp]/_q_point[_qp](0)) );
  return -1 * _mu[_qp] * ( 2 * (_grad_vel_x[_qp](0)) * (_grad_vel_x[_qp](0)) +
   2 * (_grad_vel_y[_qp](1)) * (_grad_vel_y[_qp](1)) +
    2 * (_vel_x[_qp] / _q_point[_qp](0)) * (_vel_x[_qp] / _q_point[_qp](0)) +
     (_grad_vel_x[_qp](1) + _grad_vel_y[_qp](0)) * (_grad_vel_x[_qp](1) + _grad_vel_y[_qp](0)));

  //  (_grad_vel_x[_qp](0) * _grad_vel_x[_qp](0) + _grad_vel_x[_qp](1) * _grad_vel_x[_qp](1) + 
  //  _grad_vel_y[_qp](0) * _grad_vel_y[_qp](0) + _grad_vel_y[_qp](1) * _grad_vel_y[_qp](1));
}
