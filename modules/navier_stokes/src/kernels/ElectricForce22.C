...
#include "ElectricForce22.h"
#include "NS.h"
#include "MooseVariableFE.h"
#include "SystemBase.h"

registerMooseObject("NavierStokesApp", ElectricForce22);

InputParameters
ElectricForce22::validParams()
{
...
ElectricForce22::ElectricForce22(const InputParameters & parameters)
  : Kernel(parameters),
...
Real
ElectricForce22::computeQpResidual()
{
...
Real
ElectricForce22::computeQpJacobian()
{
  return 0.;
}

Real
ElectricForce22::computeQpOffDiagJacobian(unsigned jvar)
{
  if (jvar == _c_var)
  {
 return 0.5 * _epsilon_zero * (_grad_phie[_qp](0)*_grad_phie[_qp](0)+_grad_phie[_qp](1)*_grad_phie[_qp](1)) *
...
//        0.5 * (_epsilon_water - _epsilon_air) * (_grad_c[_qp](_component)) * _test[_i][_qp];
 ...
 return 0.5 * _epsilon_zero * (2*_grad_phie[_qp](0)*_grad_phi[_j][_qp](0)+2*_grad_phie[_qp](1)*_grad_phi[_j][_qp](1)) *
        0.5 * (_epsilon_water - _epsilon_air) * (_grad_c[_qp](_component)) * _test[_i][_qp];
   }
