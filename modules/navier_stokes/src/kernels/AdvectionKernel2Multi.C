...
#include "AdvectionKernel2Multi.h"
#include "MooseMesh.h"

registerMooseObject("NavierStokesApp", AdvectionKernel2Multi);

InputParameters
AdvectionKernel2Multi::validParams()
{
...
AdvectionKernel2Multi::AdvectionKernel2Multi(const InputParameters & parameters)
  : Kernel(parameters),
...
Real
AdvectionKernel2Multi::computeQpResidual()
{
...
Real
AdvectionKernel2Multi::computeQpJacobian()
{
 return 0;
}
...
Real
AdvectionKernel2Multi::computeQpOffDiagJacobian(unsigned jvar)
{
 if (jvar == _c_var)
  {
